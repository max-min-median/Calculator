def display():
    ...
    print("          'sto[re] | = | -> <varName>' : store previous calculation into 'varName'")
    print()
    ...
    print()
    print("The previous calculation is stored as 'ans':")
    print("∙> ans  [shows previous calculation]")
    print("∙> 2ans  <repeatedly>  [number keeps doubling]")
    print("∙> ans % 2 && 3ans + 1 || ans / 2  <repeatedly>  [Collatz sequence starting with 'ans']")
    print()
